        ...
        const arrange: Arrange[] = [
            {
                ...
                expected: { id: entity.id, name: "test", description: 'some description', is_active: true, created_at: entity.created_at }
            },
            {   
                input: { id: entity.id, name: "test" },
                expected: { id: entity.id, name: "test", description: null, is_active: true, created_at: entity.created_at },
            },
            {
                input: { id: entity.id, name: "test", is_active: false },
                expected: { id: entity.id, name: "test", description: null, is_active: false, created_at: entity.created_at },
            },
            { 
                input: { id: entity.id, name: "test" },
                expected: { id: entity.id, name: "test", description: null, is_active: false, created_at: entity.created_at },
            ...
            },
            {
                ...
                expected: { id: entity.id, name: "test", description: "some description", is_active: false, created_at: entity.created_at },
            },
        ];
