...
describe('ValidatorRules Unit Tests', () => {
    ...
    test("maxLength validation rule", () => {
        ...
        const error = new ValidationError('The field must be less or equal then 5 characters');
    ...
    it('should throw a validation error when combine two or more validation rules', () => {
        ...
        expect(() => {
            ...
            new ValidationError("The field must be less or equal then 5 characters")
        );
